...
test.describe('Brand Kits', () => {
  test('Brand Kit creation and application to Doc Editor, Template Editor, Module Editor', {
    tag: ['@auth', '@doc-creation', '@page-creation', '@drag-drop', '@medialibrary', '@doc-preview', '@template-preview'],
  }, async ({ brandKitPage }) => {
